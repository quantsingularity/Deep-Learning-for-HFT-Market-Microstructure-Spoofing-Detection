...
from models.hawkes_gnn import TEN_GNN_Hybrid, HawkesProcessEstimator
...
def parse_args():
    ...
    # Model parameters
    parser.add_argument('--model_type', type=str, default='TEN', choices=['TEN', 'TEN-GNN'],
                       help='Model type to train')
    parser.add_argument('--input_dim', type=int, default=47,
    ...
    parser.add_argument('--data_path', type=str, default=None,
                       help='Path to LOB data (if available)')
    parser.add_argument('--num_samples', type=int, default=10000,
                       help='Number of synthetic samples to generate')
    parser.add_argument('--window_size', type=int, default=100,
                       help='Sequence window size')
    parser.add_argument('--spoofing_ratio', type=float, default=0.5,
                       help='Ratio of spoofing samples')
