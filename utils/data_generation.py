...
class AdversarialBacktestFramework:
    ...
    def inject_spoofing_pattern(
        ...
        for i in range(impact_start, impact_end):
            ...
            impact = impact_magnitude * progress * (-impact_direction)  # Opposite to pressure
        ...
        metadata = {
            ...
            'events': events,
            'placed_volume': sum(e['volume'] for e in events if e['event_type'] == 'placement'),
            'cancelled_volume': sum(e['volume'] for e in events if e['event_type'] == 'cancellation'),
    ...
    def generate_labeled_dataset(
        ...
        print(f"Generating {num_spoofing} spoofing samples and {num_clean} clean samples...")
